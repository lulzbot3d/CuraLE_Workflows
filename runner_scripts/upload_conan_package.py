...
def upload_conan_package(args):
    ...
    for package, details in packages["Local Cache"].items():
        ...
        for package in package_recipes:
            remote = "cura-le-private-conan2" if "@internal" in package else "cura-le-conan2"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = 'Upload the given local package(s) to the proper CuraLE conan repository')
